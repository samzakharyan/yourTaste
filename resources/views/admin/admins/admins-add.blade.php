    ...
    <main>
      <div class="container-fluid">
        <div class="card mb-4" style="margin-top: 60px">
          <div class="card-header"><i class="fas fa-table mr-1"></i>Admins Add</div>
            <div class="card-body">
                <div class="table-responsive">
                 <form method="POST" action="{{route('create-admins')}}">
                    {{csrf_field()}}
                    {{method_field('Post')}}
                    <div class="form-group col-md-6">
                        ...
                        @enderror<br>
                             Email: <input id="email" type="email" class="form-control @error('email') is-invalid 
                        ...
                        @enderror<br>
                              Confirm Password:  <input id="password-confirm" type="password" class="form-control" 
